...
GPIO_PinRemapConfig(GPIO_Remap1_CAN1, ENABLE);//更改CAN1的映射
...
CAN_FilterInitStructure.CAN_FilterIdHigh = Std_ID<<5;//ID
CAN_FilterInitStructure.CAN_FilterIdLow = 0x07FF<<5;//ID2
CAN_FilterInitStructure.CAN_FilterMaskIdHigh = 0x07FF<<5;//ID3
CAN_FilterInitStructure.CAN_FilterMaskIdLow = 0x07FF<<5;//ID4
